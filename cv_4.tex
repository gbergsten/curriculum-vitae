...
\name{Galen Bergsten}
\address{PhD Candidate $\mid$ \href{mailto:gbergsten@arizona.edu}{gbergsten@arizona.edu}}
...
\item{Schlecker, M., Apai, D., Lichtenberg, T. et al. (\textbf{Bergsten, G.} \ordinalnum{4} author) 2023, submitted: \textit{Bioverse: The Habitable Zone Inner Edge Discontinuity as an Imprint of Runaway Greenhouse Climates on Exoplanet Demographics}}\vspace{-7pt}
...
\item{Wanderley, F., Kunha, C., Souto, D. et al. (\textbf{Bergsten, G.} \ordinalnum{13} author) 2023, accepted: \textit{Stellar Characterization and Radius Inflation of Hyades M Dwarf Stars from the APOGEE Survey}}\vspace{-7pt}
